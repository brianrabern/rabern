...
# Run the script
url = "https://philpapers.org/asearch.pl?ap_c1=&proOnly=on&searchStr=%40author+Brian+Rabern+%40pubtype+%21book&search_header=search_header.html&filterMode=keywords&sort=pubYear&format=bib&freeOnly=&newWindow=&publishedOnly=on&start=&showCategories=on&sqc=&langFilter=&limit=500&hideAbstracts=off&ap_c2=&categorizerOn=&filterByAreas=&onlineOnly=&subtitle=Papers+matching+%27%40author+Brian+Rabern+%40pubtype+%21book%27&jlist=&ap_c1=&ap_c2="  # noqa
json_output = "brian-articles.json"
